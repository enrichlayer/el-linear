  ...
  describe("transformIssueData", () => {
    ...
    it("transforms project, cycle, and milestone refs", () => {
      ...
      const result = service.transformIssueData({
        ...
        projectMilestone: { id: "ms-1", name: "Beta", targetDate: "2026-06-01" },
        labels: { nodes: [] },
        createdAt: "2026-01-01T00:00:00.000Z",
        updatedAt: "2026-01-01T00:00:00.000Z",
      });
      ...
      expect(result.cycle).toEqual({ id: "cycle-1", name: "Sprint 5", number: 5 });
    ...
    it("extracts summary from completed generation", () => {
      ...
      const result = service.transformIssueData({
        ...
        summary: {
          ...
          content: {
            content: [{ text: "This issue addresses " }, { text: "a bug fix." }],
          },
        },
        labels: { nodes: [] },
        createdAt: "2026-01-01T00:00:00.000Z",
